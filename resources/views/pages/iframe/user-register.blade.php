            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">
                        <span>{{ __('Register') }} a new account</span>
                            ...
                            {{--<div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 33px, 0px);">
                                    @foreach($languages as $language)
                                        <a class="dropdown-item" href="{{route('iframe-user-register', $language->language_code)}}">{{__('login.language.' . $language->language_code)}}</a>
                                    @endforeach
                                </div>
                            </div>--}}
                        </span>
                    </div>
                    <form method="POST" action="{{ route('add-register', app()->getLocale()) }}">@csrf
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                <label for="first-name">{{ __('iframe-user-account.first-name') }} *</label>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                <label for="last-name">{{ __('iframe-user-account.last-name') }} *</label>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <select id="country" name="country" required class="form-control @error('country') is-invalid @enderror">
