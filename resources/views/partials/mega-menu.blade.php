                    ...
                    <div class="col-md-12 p-4">
                        <div class="menu-icon-grid w-auto p-0">
                            ...
                            <a href="{{ route('file-list', app()->getLocale()) }}">
                                <i class="fal fa-folder-open fa-2x mb-2"></i>Media center
                            </a>

                            <a href="{{ route('timeline-media-list', app()->getLocale()) }}">
                                <i class="fal fa-photo-video fa-2x mb-2"></i>Timeline
                            </a>

                            {{-- <a class="generic-modal" data-url="{{action('AuditsController@index', app()->getLocale())}}" data-modal-width="modal-xl"> --}}
                            <a href="#">
                                <i class="fal fa-file-chart-line fa-2x mb-2"></i>Reports
                            </a>
                            <a href="#">
                                <i class="fal fa-file-invoice-dollar fa-2x mb-2"></i>Payments
                            </a>
                            @if(auth()->user()->rule_id === 5)
                                <a href="{{-- route('mail-send-users', app()->getLocale()) --}}" id="newsletter-admin">
                                    <i class="fal fa-mail-bulk fa-2x mb-2"></i>Newsletter Test
                                </a>
                            @endif
